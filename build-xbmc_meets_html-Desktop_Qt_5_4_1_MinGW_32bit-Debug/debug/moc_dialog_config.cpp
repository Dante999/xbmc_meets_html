...
#include "../../xbmc_meets_html/dialog_config.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Dialog_Config_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 36, 0) // ""
    ...
    "Dialog_Config\0on_buttonBox_accepted\0"
    ""
};
...
void *Dialog_Config::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_Config.stringdata))
